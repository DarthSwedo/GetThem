...
--draw.WordBox( 6, ScrW() - 665, ScrH() - 110, "Blue: "..LocalPlayer():GetNWInt("NPCteam1"),"DermaLarge",Color(200,200,200,10),Color(0,0,255,255))  
...
--draw.WordBox( 6, ScrW() - 665, ScrH() - 60, "Red: "..LocalPlayer():GetNWInt("NPCteam2"),"DermaLarge",Color(200,200,200,10),Color(255,0,0,255))  
...
draw.WordBox( 6, ScrW() * 0.45, ScrH() * 0.01, "Round Time: ".. LocalPlayer():GetNWInt("roundTimer") ,"DermaLarge",Color(200,0,0,255),Color(255,255,255,255))  
  
draw.WordBox( 6, ScrW() - 1250, ScrH() - 275 , "" .. LocalPlayer():Frags() .. " spawned","DermaLarge",Color(200,0,0,0),Color(255,255,255,255))  
...
Model1Button.DoClick = function() RunConsoleCommand("weapon_take", "gman") WeaponFrame:Close() end
...
draw.RoundedBox(20,-20,0,w/2,h, Color(75,75,75,150))
end
